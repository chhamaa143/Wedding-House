...
const ShagunEnvelopes = () => {
  ...
  const envelopes = [
    {
      id: 1,
      name: "Golden Pocket Envelope",
      category: "pocket",
      price: "₹49 - ₹299",
      description: "Elegant pocket-style envelopes with golden accents",
      features: ["Golden Foil Printing", "Velvet Touch", "Secure Closure"],
      sizes: ['Small (3x4")', 'Medium (4x6")'],
    ...
    {
      id: 2,
      name: "Royal Red Pocket Envelope",
      category: "pocket",
      price: "₹59 - ₹349",
      description: "Traditional red pocket envelopes with golden designs",
      features: ["Premium Red Paper", "Intricate Designs", "Double Layer"],
      sizes: ['Medium (4x6")', 'Large (5x7")', 'X-Large (6x8")'],
    ...
    {
      id: 3,
      name: "Classic Regular Envelope",
      category: "regular",
      price: "₹29 - ₹199",
      description: "Traditional envelope style with premium paper quality",
      features: ["Premium Paper", "Multiple Colors", "Custom Printing"],
      sizes: ["A6", "A7", "DL"],
      image: "public\images\products\BoxEnv(1).png",
      popular: false,
      minOrder: 200,
    },
    {
      id: 4,
      name: "Designer Regular Envelope",
      category: "regular",
      price: "₹39 - ₹249",
      description: "Modern designs with creative patterns and embellishments",
      features: ["Designer Patterns", "Embossing", "Pearl Finish"],
      sizes: ["A6", "A7", "Custom"],
    ...
    {
      id: 5,
      name: "Luxury Box Envelope",
      category: "box",
      price: "₹99 - ₹599",
      description: "Premium box-style envelopes with magnetic closure",
      features: ["Magnetic Closure", "Premium Board", "Custom Lining"],
      sizes: ['Small (3x3x1")', 'Medium (4x4x2")', 'Large (5x5x3")'],
    ...
    {
      id: 6,
      name: "Jewel Box Envelope",
      category: "box",
      price: "₹149 - ₹799",
      description: "Jewelry-style box envelopes with velvet lining",
      features: ["Velvet Lining", "Golden Hardware", "Ribbon Tie"],
      sizes: ['Small (3x3x1")', 'Medium (4x4x2")', 'Large (6x6x3")'],
      image: "/images/gallery/7.png",
      popular: true,
      minOrder: 25,
    },
